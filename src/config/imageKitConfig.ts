...
if (!IMAGEKIT_URL_ENDPOINT || !IMAGEKIT_PUBLIC_KEY || !IMAGEKIT_AUTH_ENDPOINT) {
  console.warn(
    '[ImageKit] Variables de entorno no configuradas. ' +
    'Configure VITE_IMAGEKIT_URL_ENDPOINT, VITE_IMAGEKIT_PUBLIC_KEY, y ' +
    'VITE_IMAGEKIT_AUTHENTICATION_ENDPOINT en .env.local'
  );
}
